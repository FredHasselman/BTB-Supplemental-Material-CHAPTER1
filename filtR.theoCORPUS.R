...
filtR.theoCORPUS <- function(infile="pubmed_result0902.txt",outfile="filtRDcorpusTHEO.Rdata"){
  
  cat("\n** BEYOND THE BOUNDARY - CHAPTER THE FIRST **\n\nfiltR.theoCORPUS():\n  This function filters the text from the titles and abstracts of each article retrieved by the pubmed query ( infile =",infile,") into a VCorpus data structure (see package:tm). The terms used are listed in Appendix A.2 of Chapter 1. A data.frame (dfTheo) with raw data and a VCorpus (TMtheo) are saved in outfile = ",outfile,")\nEstablishing the conversion rules is not efficient: Filter rules need to be created quite literal, this requires expert knowledge and introduces a degree of subjectivity... In Chapter 6, filtering is omitted.\n\n")
...
tags1 <-regIT(src=stems,"(congenit|constit)")
TMcorpus<-subIT(src<-list(tags=tags1,str=" ~gen~ ",cor=TMcorpus))  
rm(tags1,src)
...
comorbid=c(
  ...
  list(lan    =c(regIT(src=stems,"agram|(il|\\b)illiter|dyssynt"))),
...
for(i in 2:(length(comorbid)-1)){
  ...
  TMcorpus<-subIT(src<-list(tags=tags3,str=" ~com~ ",cor=TMcorpus))  
...
TMcorpus<-subIT(src<-list(tags=theo,str=" ~theo~ ",cor=TMcorpus)) 
rm(tags1, tags2, tags3, src)
...
for(i in 3:length(theories)){
  ...
  TMcorpus<-subIT(src<-list(tags=types,str=" ~theo~ ",cor=TMcorpus)) 
...
TMcorpus<-subIT(src<-list(tags=tags1,str=" ~theo~ ",cor=TMcorpus)) 
rm(tags1,src)  
# THEORY REST ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
TMcorpus<-subIT(src<-list(tags=tags3,str=" ~brain~ ",cor=TMcorpus)) 
rm(tags1, tags2, tags3, src)
...
struct   <-tagIT(gregexpr(wordXsYr(struc,c("~brain~","anatom","anatomi")),TMcorpus,perl=TRUE),TMcorpus)

struct1 <-unique(c(struc,loca,named,namloc,namstr,locstr,namlocnam,namlocstr,locstrnam,struct)) 
TMcorpus<-subIT(src<-list(tags=struct1,str=" ~brain~ ",cor=TMcorpus))   

struct2   <-tagIT(gregexpr(wordXsYr("~brain~",c("~brain~","~brain~","anatom","anatomi")),TMcorpus,perl=TRUE),TMcorpus)
TMcorpus<-subIT(src<-list(tags=struct2,str=" ~brain~ ",cor=TMcorpus))   
...
TMcorpus<-subIT(src<-list(tags=funct,str=" ~brain~ ",cor=TMcorpus))     

rm(tags1,tags2,tags3,tags4,tags5,tags6,tags7,func,funcs,funct,src)
# NEURO MEASUREMENT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
tags4 <-tagIT(gregexpr(wordXsYro(tags3,"~brain~"),TMcorpus,perl=TRUE),TMcorpus)
tags5 <-tagIT(gregexpr(wordXsYr(tags4,"~brain~"),TMcorpus,perl=TRUE),TMcorpus)

TMcorpus<-subIT(src<-list(tags=tags4,str=" ~brain~ ",cor=TMcorpus))     

rm(tags1,tags2,tags3,tags4,tags5,src)
# NEUR PATHOLOGY ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
TMcorpus<-subIT(src<-list(tags=tags3,str=" ~gen~ ",cor=TMcorpus))     
rm(tags1,tags2,tags3,src)
# BIO DEVELOPMENT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
TMcorpus<-subIT(src<-list(tags=tags3,str=" ~dev~ ",cor=TMcorpus))     
rm(tags1,tags2,tags3,src)
# BIO ENVIRONMENT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
TMcorpus<-subIT(src<-list(tags=tags3,str=" ~env~ ",cor=TMcorpus))     
rm(tags1,tags2,tags3,src)
# BIO ENVIR_GENE ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
TMcorpus<-subIT(src<-list(tags=tags3,str=" ~bod~ ",cor=TMcorpus))     
rm(tags1,tags2,tags3,src)
...
speech =c(
  ...
  list(tmp=c(theories$tmp,regIT(src=stems,"^rate$|slow|^dur"))),
...
TMcorpus<-subIT(src<-list(tags=unmod,str=" ~lan~ ",cor=TMcorpus))     
...
TMcorpus<-subIT(src<-list(tags=spr4,str=" ~act~ ",cor=TMcorpus))     
...
TMcorpus<-subIT(src<-list(tags=tags3,str=" ~tmp~ ",cor=TMcorpus))     
rm(tags1,tags2,tags3,src)
...
TMcorpus<-subIT(src<-list(tags=scrp,str=" ~act~ ",cor=TMcorpus))     
...
unmod2 <-tagIT(gregexpr(wordXsYr("~act~",unmod1),TMcorpus,perl=TRUE),TMcorpus)
unmod3 <-tagIT(gregexpr(wordXsYr(mod,unmod1),TMcorpus,perl=TRUE),TMcorpus)

unmod   <-unique(c(mod,unmod2,unmod3))
TMcorpus<-subIT(src<-list(tags=unmod,str=" ~act~ ",cor=TMcorpus))     
...
tags1  <-tagIT(gregexpr(wordXsYr("~act~",actmods),TMcorpus,perl=TRUE),TMcorpus)
tags2  <-tagIT(gregexpr(wordXsYr("~act~",actmods),TMcorpus,perl=TRUE),TMcorpus)
actwri   <-unique(c(tags1,tags2))
TMcorpus<-subIT(src<-list(tags=actwri,str=" ~act~ ",cor=TMcorpus))     
...
TMcorpus<-subIT(src<-list(tags=aud,str=" ~aud~ ",cor=TMcorpus))     
rm(tags1,tags2,tags3,src)
...
TMcorpus<-subIT(src<-list(tags=viz,str=" ~viz~ ",cor=TMcorpus))     
...
TMcorpus<-subIT(src<-list(tags=soma,str=" ~som~ ",cor=TMcorpus))     
...
TMcorpus<-subIT(src<-list(tags=tags1,str=" ~mlt~ ",cor=TMcorpus))    
...
for(i in 4:(length(action)-1)){
  ...
  TMcorpus<-subIT(src<-list(tags=types,str=" ~act~ ",cor=TMcorpus)) 
  rm(tags1,tags2,tags3,types,src)
}
...
TMcorpus<-subIT(src<-list(tags=rs,str=" ~rdsp~ ",cor=TMcorpus))     
...
learn=c(
  ...
  list(per     =c(regIT(src=stems,"audit|^visu|^sens$|sensori$|perceptu"),"auditori\\sprocess","audit\\svision","~per~","~viz~","~aud~")),
...
for(i in 3:(length(learn)-1)){
  ...
  TMcorpus<-subIT(src<-list(tags=types,str=" ~lrn~ ",cor=TMcorpus)) 
  rm(tags1,tags2,tags3,types,src)
}

tags1 <- tagIT(gregexpr("(impair)|(disord$)|(deficit*$)|(abnorm)|(dysfunct)|(disabl)|(poor)|(syndrom)|(difficulti)",TMcorpus,perl=TRUE),TMcorpus)
TMcorpus<-subIT(src<-list(tags=tags1,str=" ~imp~ ",cor=TMcorpus))     
rm(tags1,src)

x<-regIT(src=stems,"^behav")
tags1 <- tagIT(gregexpr(wordXX(x),TMcorpus,perl=TRUE),TMcorpus)
TMcorpus<-subIT(src<-list(tags=tags1,str=" ~beh~ ",cor=TMcorpus))     
rm(tags1,src)

TMtheo <- subNIT2(src<-list(tags="\\~\\w+\\~",str=" ",cor=TMcorpus))     
dfTheo <- df

save(TMtheo,dfTheo,file=outfile)
